      ...
      <div class="mb-3 seleccion">        
        ...
        <div class="input-group me-1 ">   
          <select class="form-select text-center me-1" @change="onChange($event)" id="nombre_carrera" :disabled="gestionActivated" v-model="selectedStatus">              
            ...
            <select class="form-select text-center me-1" @change="onChanges($event)" id="gestiones"  v-model="selectedStatus2">              
              <option value="" selected >
              <!-- ---Departamento Nacimiento--- -->
              <!-- -------------Gestión------------- -->
                          TODAS LAS GESTIONES
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="input-group mb-3"> 
            ...
            <select class="form-select text-center" @change="onChange($event)" id="nombre_carrera" :disabled="gestionActivated" v-model="selectedStatus">              
              <option value="" selected >
          ...
          <div class="input-group mb-3"> 
            ...
            <select class="form-select text-center" @change="onChanges($event)" id="gestiones"  v-model="selectedStatus2">              
              <option value="" selected >
